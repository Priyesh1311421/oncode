...
-- CreateIndex
CREATE UNIQUE INDEX "CodeSnippet_url_key" ON "CodeSnippet"("url");
...
-- AddForeignKey
ALTER TABLE "ExecutionLog" ADD CONSTRAINT "ExecutionLog_snippetId_fkey" FOREIGN KEY ("snippetId") REFERENCES "CodeSnippet"("id") ON DELETE SET NULL ON UPDATE CASCADE;
